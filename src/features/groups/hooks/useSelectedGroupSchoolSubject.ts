...
export const useSelectedGroupSchoolSubject = () => {
  ...
  const selectedGroupSchoolSubjectId =
    selectedGroupSchoolSubjectEntity?.get(IdentifierFacet)?.props.guid;
  const selectedGroupSchoolSubjectTitle =
    selectedGroupSchoolSubjectEntity?.get(TitleFacet)?.props.title;
