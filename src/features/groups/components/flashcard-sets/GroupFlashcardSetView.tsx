...
const GroupFlashcardSetView = (
  ...
  const openEditGroupFlashcardSetSheet = () =>
    lsc.stories.transitTo(Stories.EDETING_GROUP_FLASHCARD_SET_STORY);
  const openDeleteGroupFlashcardSetAlert = () =>
    lsc.stories.transitTo(Stories.DELETING_GROUP_FLASHCARD_SET_STORY);
    ...
    <Fragment>
      ...
      <View visible={isVisible}>
            ...
            content={
              <Fragment>
                <ActionRow
                  ...
                  onClick={openEditGroupFlashcardSetSheet}
                >
                ...
                <ActionRow
                  ...
                  last
                  icon={<IoTrashOutline />}
                  onClick={openDeleteGroupFlashcardSetAlert}
                >
        ...
        <CollectionGrid columnSize="large">
          <EntityPropsMapper
            query={(e) =>
              e.hasTag(DataTypes.GROUP_FLASHCARD) && isChildOfQuery(e, entity)
            }
