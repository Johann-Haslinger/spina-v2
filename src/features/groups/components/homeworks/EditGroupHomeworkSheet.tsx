...
const EditGroupHomeworkSheet = () => {
  ...
  const updateGroupHomework = async () => {
    if (newTitle && newDueDate) {
      ...
      selectedGroupHomeworkEntity?.add(
        new DueDateFacet({ dueDate: newDueDate }),
      );
  ...
  return (
    <Sheet visible={isVisible} navigateBack={navigateBack}>
      <FlexBox>
        ...
        {(newTitle !== selectedGroupHomeworkTitle ||
          newDueDate !== selectedGroupHomeworkDueDate) && (
          <PrimaryButton onClick={updateGroupHomework}>
