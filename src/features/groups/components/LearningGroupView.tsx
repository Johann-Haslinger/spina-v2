...
const LearningGroupView = (
  props: TitleProps & DescriptionProps & ColorProps & EntityProps,
) => {
  ...
  const openEditLearningGroupSheet = () =>
    lsc.stories.transitTo(Stories.EDITING_LEARNING_GROUP_STORY);
  const openDeleteLearningGroupAlert = () =>
    lsc.stories.transitTo(Stories.DELETING_LERNING_GROUP_STORY);
    ...
    <Fragment>
      ...
      <View visible={isVisible}>
          ...
          <NavBarButton
            content={
              <Fragment>
                <ActionRow
                  first
                  onClick={openEditLearningGroupSheet}
                ...
                <ActionRow
                  destructive
                  last
                  onClick={openDeleteLearningGroupAlert}
                  icon={<IoTrashOutline />}
                >
        ...
        <CollectionGrid>
          <EntityPropsMapper
            query={(e) =>
              dataTypeQuery(e, DataTypes.GROUP_SCHOOL_SUBJECT) &&
